...
public class Main extends Frame {
    ...
    private static Main staticGUI;

    static boolean getTestOption() {
        return staticGUI._cmd.hasOption('t');
    }

    static boolean getFetchOption() {
        return staticGUI._cmd.hasOption('f');
    }
    ...
    static void success(String format, Object... args) {
        log(MessageStyle.Success, format, args);
    }

    private static void throwableErr(Throwable t) {
    ...
    static void err(Error err) {
        throwableErr(err);
    }

    private static void appendStyledStringMain(MessageStyle style, String s) {
    ...
    private static void appendStyledString(final MessageStyle style, final String s) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                Main.appendStyledStringMain(style, s);
            }
        });
    }

    private static AttributeSet attrsFromStyle(MessageStyle s) {
    ...
    static void log(MessageStyle style, String format, Object... args) {
    ...
    private Main(CommandLine cmd) {
        ...
        this._cmd = cmd;
        SwingUtilities.invokeLater(new Runnable() {
            //help prevent some weird Swing-related deadlocks
            public void run() {
                guiInit();
            }
        });
